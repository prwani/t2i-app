...
Use these focused docs instead of a single implementation plan:

- [Architecture](architecture.md)
- [Web and API app](web-app.md)
- [SDK](sdk.md)
...
Additional developer assets:

- [Developer notebooks](../notebooks/README.md)
- [TechCommunity-style blog](../blog/techcommunity-image-asset-workflow.html)
